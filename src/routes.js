...
route.post('/cobranca/cadastro/:id', validateBody(SchemesCharges), registerCharges)
route.put('/cobranca/editar/:id', validateBody(SchemesCharges), updateCharges)
route.get('/cobranca', validateBody(SchemesCharges), listCharges)
route.delete('/cobranca/delete/:id', validateBody(SchemesCharges), deleteCharges)
